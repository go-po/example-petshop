...
import (
	...
	"github.com/go-po/example-petstore/generated/server/restapi/operations/user"
)

//go:generate swagger generate server --target ../../server --name ExamplePetstore --spec ../../../api/petstore.yaml --exclude-main

func configureFlags(api *operations.ExamplePetstoreAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.ExamplePetstoreAPI) http.Handler {
